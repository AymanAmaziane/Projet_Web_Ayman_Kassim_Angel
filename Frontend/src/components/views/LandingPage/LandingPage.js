...
function LandingPage() {
    ...
    useEffect(() => { //dès que le rendu du composant s'est terminé
        const movieTopRated = `${API_URL}movie/top_rated?api_key=${API_KEY}&language=fr-FR&page=1`;  //on crée un lien pour chaque sections 
        ...
        fetchMovies(movieTopRated, Movies1, setMovies1, MainMovie1Image, setMainMovie1Image)  //Puis on organise les données 
    ...
    return (
        <div className="AllMoviesSections" style={{ width: '100%', margin: '0' }}>
            ...
            <div className="MoviesSection" style={{ width: '85%', margin: '1rem auto' }}>
                <Title> Série les plus populaires </Title>
                <hr />
                <Row gutter={[16, 16]}>
